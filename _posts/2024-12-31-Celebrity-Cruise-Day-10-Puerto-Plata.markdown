...
transport:
  - type: cruise_ship
    ...
    notes: Last port stop before heading home
  - type: bus
    description: Tour bus to zipline facility
  - type: tuk_tuk
    from: Taino Bay
    to: Celebrity Eclipse
    notes: Return trip from Taino Bay to ship
venues:
  - name: Puerto Plata
    type: port
    location: Dominican Republic
    notes: Major cruise port on north side of Dominican Republic
  - name: San Felipe De Puerto Plata
    type: zipline_facility
    location: Puerto Plata area
    notes: Zipline excursion facility, also offers ATV and horseback trips
  - name: Taino Bay
    type: resort_complex
    location: Puerto Plata
    notes: Secured area between ships and city with shops, restaurants, pools, lazy river, and splash surfing
  - name: Celebrity Eclipse
    type: cruise_ship
    location: Docked in Puerto Plata
activities:
  - day: 10
    type: shore_excursion
    description: Zipline excursion at San Felipe De Puerto Plata
    location: Puerto Plata area
    participants: Father and daughter (son's ankle still healing, wife didn't care for heights)
  - day: 10
    type: relaxation
    description: Enjoyed lazy river and pool area at Taino Bay
    location: Taino Bay, Puerto Plata
  - day: 10
    type: activity
    description: Daughter tried splash surfing attraction
    location: Taino Bay
days_at_location:
  Puerto Plata: 1
---
...
<img src="/assets/20241231-zipline3.jpg" width="100%" alt="Father and daughter posing in zipline safety gear with harnesses and helmets in Dominican Republic" />
...
<img src="/assets/20241231-taino.jpg" width="100%" alt="Taino Bay cruise port entrance sign for Puerto Plata, Dominican Republic" />
...
<img src="/assets/20241231-lazyriver.jpg" width="100%" alt="Lazy river and pool area at Taino Bay resort complex in Puerto Plata" />

So long, Puerto Plata:
<img src="/assets/20241231-leavingdr.jpg" width="100%" alt="View of Puerto Plata coastline from Celebrity Eclipse as ship departs Dominican Republic" />
