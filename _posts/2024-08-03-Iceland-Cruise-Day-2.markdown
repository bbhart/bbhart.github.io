...
transport:
  ...
  - type: flight
    ...
    airline: United
  - type: ferry
    from: Paulus Hook, Jersey City
    to: Brookfield Place, Manhattan
    time: 10:10am
    notes: Two minute walk from hotel
  - type: ferry
    from: Manhattan
    to: Jersey City
    notes: Return trip after storms
venues:
  - name: United Club
    type: airport_lounge
    location: Raleigh-Durham Airport
  - name: Hyatt House Jersey City
    type: hotel
    location: Jersey City, NJ
    notes: Digital key issues, weird elevators
  ...
  - name: One World Trade Center
    ...
    location: Lower Manhattan
    notes: 11:30am reservation, three floors at top
  - name: The Oculus
    type: transportation_hub
    location: Lower Manhattan
    notes: Mall and station with distinctive architecture
  - name: PATH Station Playground
    type: playground
    location: Jersey City
activities:
  - day: 2
    type: travel
    description: Early morning 7am flight from RDU to Newark
    location: Raleigh to Newark
  - day: 2
    type: sightseeing
    description: Ferry to Manhattan and visit to One World Trade Center observation deck
    duration: 11:30am reservation
    location: Lower Manhattan
  - day: 2
    type: sightseeing
    description: Visited Oculus transportation hub and mall
    location: Lower Manhattan
  - day: 2
    type: dining
    description: Crepes at Brookfield Place, later Subway and Sweetgreen
    location: Manhattan and Jersey City
  - day: 2
    type: relaxation
    description: Returned to hotel due to severe weather forecast
    location: Hyatt House Jersey City
  - day: 2
    type: recreation
    description: Playground visit and photos by river after rain stopped
...
<img src="/assets/20240803-lounge.jpg" width="100%" alt="United Club lounge at early morning with seating areas and windows">
...
<img src="/assets/20240803-ferry.jpg" width="100%" alt="Ferry from Paulus Hook terminal in Jersey City crossing Hudson River to Manhattan">
...
<img src="/assets/20240803-wtc-downstairs.jpg" width="100%" alt="Queue area in basement of One World Trade Center with displays before elevator to observation deck">
...
<img src="/assets/20240803-wtc1.jpg" width="100%" alt="Spectacular aerial view of New York City skyline from One World Trade Center observation deck on clear sunny day">
<img src="/assets/20240803-wtc2.jpg" width="100%" alt="Panoramic view from One World Trade Center showing downtown Manhattan, rivers, and bridges">

We made our way back down to ground level, then over to the connected Oculus mall/station. 

<img src="/assets/20240803-oculus.jpg" width="100%" alt="Interior of the Oculus transportation hub and mall with distinctive white ribbed architecture and natural light">
...
<img src="/assets/20240803-nyc-night-jerseycity.jpg" width="100%" alt="Evening view of illuminated New York City skyline from Jersey City waterfront after rain">

<img src="/assets/20240803-playground.jpg" width="100%" alt="Family at playground near PATH station in Jersey City with NYC skyline in background">
