...
transport:
  - type: uber
    from: Jersey City
    to: Bayonne cruise terminal
    time: noon
  - type: cruise_ship
    vessel: Celebrity Eclipse
    from: Bayonne, NJ
    to: At sea
    time: 4:00pm sailaway
    notes: Full cruise, stormy sailaway through New York Harbor
venues:
  - name: Jersey City Riverwalk
    type: waterfront
    location: Jersey City, NJ
  - name: Bayonne Cruise Terminal
    type: cruise_port
    location: Bayonne, NJ
    notes: Smooth check-in despite full cruise
  - name: Celebrity Eclipse
    type: cruise_ship
    location: Departed New York Harbor
activities:
  - day: 3
    type: recreation
    description: Morning walk on Jersey City riverwalk with Starbucks breakfast
    location: Jersey City
  - day: 3
    type: travel
    description: Embarkation at Bayonne cruise terminal
    location: Bayonne, NJ
  - day: 3
    type: sightseeing
    description: Stormy sailaway viewing Statue of Liberty, lower Manhattan, and Verrazano Bridge
    time: 4:00pm
    location: New York Harbor
  - day: 3
    type: dining
    description: First dinner in main dining room
    time: 8:30pm
    location: Celebrity Eclipse
days_at_location:
  Jersey City: 0.5
  Celebrity Eclipse: 0.5
---
...
<img src="/assets/20240804-siena-faces.jpg" width="50%" alt="Daughter making silly faces on Jersey City riverwalk">
...
<img src="/assets/20240804-stateroom.jpg" width="100%" alt="Celebrity Eclipse cruise ship stateroom with beds, seating area, and balcony">
...
<img src="/assets/20240804-harbor1.jpg" width="100%" alt="Statue of Liberty viewed from Celebrity Eclipse during stormy sailaway from New York Harbor">

<img src="/assets/20240804-harbor2.jpg" width="100%" alt="Lower Manhattan skyline and storm clouds during dramatic sailaway from New York Harbor">
...
<img src="/assets/20240804-sunset.jpg" width="100%" alt="Sunset breaking through clouds and fog over ocean from cruise ship deck">
...
<img src="/assets/20240804-kids-night.jpg" width="100%" alt="Kids at main dining room table on first night of cruise">
