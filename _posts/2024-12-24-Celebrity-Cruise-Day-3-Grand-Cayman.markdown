...
transport:
  - type: cruise_ship
    ...
    notes: Ship tendered outside George Town
venues:
  - name: George Town
    type: port
    location: Grand Cayman
    notes: Tendered port, gray weather, high 70s and humid
...
activities:
  - day: 3
    type: port_day
    description: Ship tendered at Grand Cayman, stayed aboard due to son's injury
    location: George Town, Grand Cayman
  - day: 3
    type: relaxation
    description: Wandered ship, listened to music, admired holiday decorations
    location: Celebrity Eclipse
  - day: 3
    type: dining
    description: Special Christmas Eve menu in main dining room
    location: Celebrity Eclipse
days_at_location:
  George Town: 1
  Celebrity Eclipse: 1
...
<img src="/assets/20241224-ornament.jpg" width="100%" alt="Elegant Christmas ornament decoration aboard the Celebrity cruise ship" />
...
<img src="/assets/20241224-partyband.jpg" alt="Digital event sign on the ship promoting Christmas Eve Party With Party Band Next Stage" />

<img src="/assets/20241224-wind-and-crutches.jpg" alt="View of the top deck lawn with crutches visible in windy conditions" />

<img src="/assets/20241224-rowan-crutches-2.jpg" alt="Person on crutches on the ship's top deck experiencing strong winds" />
