...
background: "/assets/2024-kura.jpg"
venues:
  ...
  - name: Kura Sushi
    type: restaurant
    location: Asakusa, Tokyo
    notes: Revolving sushi restaurant on 4th floor of department store
...
activities:
  - day: 3
    type: sightseeing
    description: Early morning visit to Senso-Ji Temple without crowds
    location: Senso-Ji, Asakusa
    time: 5:30am
  - day: 3
    type: dining
    description: Hotel breakfast with Western and Japanese options
    location: Asakusa View Annex Rokku
  - day: 3
    type: dining
    description: Solo lunch at Kura revolving sushi restaurant
    location: Kura Sushi, Asakusa
  - day: 3
    type: sightseeing
    description: Walking tour and visit to Tokyo National Museum
    location: Tokyo National Museum, Ueno
    distance: 2km walk
  - day: 3
    type: dining
    description: Light dinner from convenience store
    location: FamilyMart, Asakusa
transport:
  - type: walking
    from: Hotel
    to: Senso-Ji Temple
...
<img src="/assets/2024-asakusa-view-breakfast.jpg" width="50%" alt="Western breakfast plate featuring scrambled eggs, bacon, a hash brown, and sliced bread with butter and jam, served on elegant china with a patterned rim at a hotel restaurant">
...
<img src="/assets/2024-kura.jpg" width="50%" alt="Interior of Kura Sushi restaurant showing traditional Japanese design with low wooden tables, tatami-style seating booths numbered 32 and 33, and an elaborate wooden lattice ceiling with pendant lights">
...
<img src="/assets/2024-kura-menu.jpg" width="50%" alt="Smartphone screen displaying Kura Sushi's digital ordering menu in Japanese, showing various sushi options with photos and prices ranging from 132 to 830 yen, with seat number 47 visible at the top">
...
<img src="/assets/2024-kura-inside.jpg" width="50%" alt="Wide view of Kura Sushi restaurant interior featuring numbered seating booths, a conveyor belt sushi system, minimal modern Japanese design with light wood throughout">
...
<img src="/assets/2024-tokyo-museum1.jpg" width="50%" alt="Exterior of Tokyo National Museum Heiseikan building featuring traditional Japanese architecture with curved rooflines, stone construction, and landscaped grounds with bare winter trees under clear blue skies">

***

<img src="/assets/2024-tokyo-museum2.jpg" width="50%" alt="Wooden statue of seated Buddha Amida from 1147 in meditation pose with raised right hand, displayed against a dark background in a museum setting">
...
<img src="/assets/2024-asakusa-view-lounge.jpg" width="50%" alt="Lounge at Asakusa View Annex Rokku">
