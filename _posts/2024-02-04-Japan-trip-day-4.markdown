...
background: "/assets/2024-tokyo-shrine3.jpg"
venues:
  - name: Asakusa Underground Street
    type: shopping
    location: Asakusa Station, Tokyo
    notes: Underground shopping arcade
...
activities:
  - day: 4
    type: sightseeing
    description: Visit to Asakusa Underground Street
    location: Asakusa Station, Tokyo
  - day: 4
    type: sightseeing
    description: Walking across Shibuya Scramble Crossing
    location: Shibuya, Tokyo
  - day: 4
    type: sightseeing
    description: Exploration of Shibuya shopping district
    location: Shibuya, Tokyo
  - day: 4
    type: dining
    description: Coffee at CAFÉ Mori no Terrace
    location: Meiji Shrine area, Tokyo
  - day: 4
    type: sightseeing
    description: Visit to Meiji Shrine and park
    location: Meiji Jingu, Tokyo
  - day: 4
    type: dining
    description: Sushi dinner at restaurant near hotel
...
<img src="/assets/2024-toilets-comparison.png" width="50%" alt="Comparison chart of toilet features across Japanese hotels showing Asakusa View Hotel Rokku, Hotel Metropolitan Kamakura, and Hotel Granvia Kyoto, plus home toilet, with checkmarks and X marks for features like heated water, heated seat, water pressure, self flushing, dryer, and auto open lid">
...
<img src="/assets/2024-tokyo-crossing.jpg" width="75%" alt="Aerial view of Shibuya Scramble Crossing in Tokyo showing hundreds of pedestrians crossing the busy intersection in all directions, surrounded by bright commercial buildings, shops, and iconic signage including TSUTAYA and IKEA">
...
<img src="/assets/2024-tokyo-subwayride.jpg" width="75%" alt="Tokyo subway map showing transit route from Asakusa to Shibuya City highlighted in orange, with estimated travel time of 1 hour 10 minutes displayed, showing the vast expanse of Tokyo's metro system">
...
<img src="/assets/2024-tokyo-usbrands.jpg" width="75%" alt="Bustling Shibuya street scene showing mix of Western brands including British Pub, IKEA, and Burger King alongside traditional Japanese establishments, with pedestrians on cobblestone walkway">
...
<img src="/assets/2024-tokyo-bhshrine.jpg" width="75%" alt="Selfie at Meiji Shrine entrance with traditional wooden torii gate in background, surrounded by mature trees and other visitors, overcast winter day in Tokyo">

<img src="/assets/2024-tokyo-meijijingu.jpg" width="75%" alt="Wide view of Meiji Shrine main hall showing traditional Japanese architecture with curved roofline, visitors gathered in the expansive courtyard, framed by large trees under cloudy skies with Tokyo Skytree visible in the distance">
...
<img src="/assets/2024-tokyo-shrine3.jpg" width="75%" alt="Modern glass-fronted cafe and restaurant buildings nestled among lush trees near Meiji Shrine, with visitors walking past directional signage, creating a Northern California-like atmosphere in Tokyo">
