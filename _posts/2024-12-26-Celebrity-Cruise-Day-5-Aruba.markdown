...
transport:
  - type: cruise_ship
    ...
    from: At sea
    to: Oranjestad, Aruba
    notes: Docked until 8:30pm
  - type: boat
    vessel: La Tigre catamaran
    description: Sailing and snorkeling excursion
    duration: 3 hours
venues:
  - name: Oranjestad
    type: port
    location: Aruba
    notes: One of the ABC Islands (Aruba, Bonaire, Curaçao), constituent country of Kingdom of the Netherlands
  - name: Celebrity Eclipse
    type: cruise_ship
    location: Docked in Aruba
  - name: La Tigre
    type: catamaran
    location: Aruba waters
    notes: Sailing and snorkeling tour vessel
activities:
  - day: 5
    type: shore_excursion
    description: Sailing and snorkeling trip on catamaran La Tigre
    duration: 3 hours
    location: Aruba waters
    participants: Father and daughter
  - day: 5
    type: shopping
    description: Shopping in Oranjestad
    location: Oranjestad, Aruba
  - day: 5
    type: dining
    description: Main dining room dinner
...
<img src="/assets/20241226-latigre.jpg" width="100%" alt="White catamaran sailboat 'La Tigre' docked at Aruba marina with modern hotels and colorful Dutch Colonial architecture visible in background" />

<img src="/assets/20241226-aruba-ship.jpg" width="100%" alt="View from catamaran of Celebrity Eclipse cruise ship docked in Aruba harbor, showing the massive blue and white vessel from water level in turquoise Caribbean waters" />

<img src="/assets/20241226-aruba-snorkel.jpg" width="100%" alt="Father and son snorkeling in crystal clear turquoise Caribbean waters near orange buoy marker in Aruba, both waving at camera with snorkel masks" />

<img src="/assets/20241226-aruba-sign.jpg" width="100%" alt="Colorful wooden 'ARUBA' sign with each letter painted in different bright colors including pink, yellow, and green, mounted on waterfront dock" />
