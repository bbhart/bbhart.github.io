...
transport:
  - type: cruise_ship
    ...
    time: Early morning arrival
    notes: Ship performed 180-degree turn to dock starboard side
venues:
  - name: Halifax Harbor
    type: port
    location: Halifax, Nova Scotia
    notes: Docked downtown, cell coverage with US/Canada plan
  - name: Tim Hortons
    type: restaurant
  ...
  - name: Halifax Waterfront
    type: waterfront
    location: Halifax, Nova Scotia
    notes: New development with Deloitte-anchored condos and Cunard project
  ...
  - name: Celebrity Eclipse
    type: cruise_ship
    location: Halifax then at sea to St. John's
activities:
  - day: 5
    type: arrival
    description: Early morning arrival in Halifax with fog, watched docking maneuver from top deck
    time: 5:30am - 7:00am
    location: Halifax Harbor
  - day: 5
    type: sightseeing
    description: Disembarked and walked Halifax waterfront meeting family members
    time: 10:00am
    location: Halifax waterfront
  - day: 5
    type: dining
    description: Tim Hortons stop for treats
    location: Halifax waterfront
  - day: 5
    type: social
    description: Met with Ann, Greg, Shane, Katie, Will, and Sam at the wave landmark
    time: 10:45am
    location: Halifax waterfront
  - day: 5
    type: shopping
    description: Sherri and Siena shopped on Spring Garden Road and visited Lululemon, met Amanda
    location: Spring Garden Road
  - day: 5
    type: social
    description: Sherri connected with Aunts Betty, Dorothy, and Kay
    location: Halifax
  - day: 5
    type: dining
    description: Lunch onboard ship
    location: Celebrity Eclipse
  - day: 5
    type: sightseeing
    description: Sailaway viewing McNab's and Georges Islands from 200 feet up
    time: Afternoon
    location: Halifax Harbor departure
  - day: 5
    type: entertainment
    description: Kids attended illusionist show in main theater
    time: Evening
    location: Celebrity Eclipse
  - day: 5
    type: dining
    description: Dinner in main dining room, unusually quick service
    time: Evening
    location: Celebrity Eclipse
days_at_location:
  Halifax: 1
...
<img src="/assets/20240806-halifax1.jpg" width="100%" alt="Woman photographing Halifax harbor skyline from cruise ship deck on cloudy morning as Celebrity Eclipse arrives in port">

<img src="/assets/20240806-halifax2.jpg" width="100%" alt="Aerial view of Halifax downtown waterfront showing modern development with colorful buildings and cruise terminal from ship deck">
...
<img src="/assets/20240806-halifax3.jpg" width="100%" alt="Two siblings sitting beneath large Canadian flag waving against cloudy sky on Halifax waterfront">

<img src="/assets/20240806-halifax4.jpg" width="100%" alt="Four family members posing together in decorative Canada 150 photo frame on Halifax waterfront boardwalk">

<img src="/assets/20240806-halifax5.jpg" width="100%" alt="Teen boy sitting on stone steps in front of modern glass office building in downtown Halifax">
...
<img src="/assets/20240806-sunset-siena.jpg" width="100%" alt="Teen girl in white hoodie on cruise ship balcony at sunset with golden light reflecting on ocean">
...
<img src="/assets/20240806-halifax-development.jpg" width="100%" alt="Architectural rendering of Cunard waterfront development project in Halifax showing new public space opening 2024">