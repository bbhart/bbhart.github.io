...
transport:
  - type: cruise_ship
    ...
    from: Curaçao
    to: Kralendijk, Bonaire
    notes: Departure delayed 1 hour to 6:30pm due to medical emergencies
venues:
  - name: Kralendijk
    type: port
    location: Bonaire
    notes: Last of ABC Islands, smallest at 112 sq miles and ~21,000 population, outside hurricane belt
  - name: Celebrity Eclipse
    type: cruise_ship
    location: Docked in Bonaire
  - name: Murano
    type: restaurant
    location: Celebrity Eclipse
    notes: Premium French restaurant onboard ship
activities:
  - day: 7
    type: sightseeing
    description: Walking tour through downtown Kralendijk
    location: Kralendijk, Bonaire
    participants: Three family members (son stayed aboard with friend)
  - day: 7
    type: dining
    description: Premium dining at Murano French restaurant celebrating milestone
    location: Celebrity Eclipse
days_at_location:
  Bonaire: 1
---
...
<img src="/assets/20241228-bonaire-building.jpg" width="100%" alt="Colorful Dutch Colonial style building in downtown Kralendijk, Bonaire with yellow and coral painted facade" />

<img src="/assets/20241228-bonaire-timecapsule.jpg" width="100%" alt="Time capsule monument in Kralendijk, Bonaire commemorating a historic date" />

<img src="/assets/20241228-bonaire-biggreenegg.jpg" width="100%" alt="Large Big Green Egg grill display or statue in downtown Kralendijk" />

<img src="/assets/20241228-bonaire-flamingos.jpg" width="100%" alt="Pink flamingo decorations or artwork in Kralendijk, Bonaire" />
...
<img src="/assets/20241228-bonaire-donkey-mural.jpg" width="100%" alt="Colorful mural featuring a donkey on building wall in Kralendijk, Bonaire" />
...
<img src="/assets/20241228-bonainre-ambulance.jpg" width="100%" alt="Ambulance at the cruise port in Bonaire assisting with medical emergency" />

<img src="/assets/20241228-bonaire-cruiseport1.jpg" width="100%" alt="View of Kralendijk cruise port with Celebrity Eclipse docked" />

<img src="/assets/20241228-bonaire-cruiseport2.jpg" width="100%" alt="Aerial or elevated view of Bonaire cruise port terminal and waterfront" />
