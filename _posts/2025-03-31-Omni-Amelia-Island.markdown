...
hotels:
  - name: Omni Amelia Island Resort
    ...
    nights: 3
    room_type: Deluxe Oceanfront Room with 2 Queen Beds
    room_number: 441
    rating: 3
    notes: Deferred maintenance issues, humid room, but nice grounds and pool area
transport:
  - type: car
    from: Raleigh-Durham, NC
    to: Amelia Island, FL
    notes: First stop on nine-day vacation to Walt Disney World
activities:
  - type: dining
    description: Meals at Marché Burette and Falcon's Nest restaurants
    location: Omni Amelia Island Resort
  - type: relaxation
    description: Pool and fire pit lounging
    location: Omni Amelia Island Resort
days_at_location:
  Amelia Island: 4
locations:
...
<img src="/assets/20250328-omni-beach-view-from-room.jpg" width="100%" alt="Elevated view from hotel room showing resort pool area with lounge chairs and cabanas, palm trees, sandy beach, and Atlantic Ocean under partly cloudy sky">

Though the door didn't leave the best first (or last) impression:
<img src="/assets/20250331-omni-door.jpg" width="100%" alt="White hotel room door for room 441 showing significant rust stains and corrosion around panel edges, demonstrating deferred maintenance">

The fire was nice, though I don't want to think about the gas bill:
<img src="/assets/20250328-fireplace-at-omni.jpg" width="100%" alt="Gas fire pit with flames burning over river rocks at dusk, Adirondack chairs visible poolside with palm trees and cloudy sky in background">
