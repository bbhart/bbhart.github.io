...
transport:
  ...
  - type: flight
    ...
    airline: Unknown
  - type: train
    from: Tokyo-Haneda Airport Terminal 3
    to: Asakusa Station
    duration: 40 minutes
    line: Unknown
    notes: Used Suica card for payment
  - type: walking
...
venues:
  ...
  - name: Asakusa Station
    type: train_station
    location: Tokyo, Japan
  - name: Nakamise-dori Street
    type: street
    location: Asakusa, Tokyo
    notes: Famous shopping street
activities:
  - day: 1
    type: travel
    description: Flight from Raleigh to Tokyo via Minneapolis
    duration: 16.5 hours
  - day: 1
    type: sightseeing
    description: Initial exploration of Asakusa neighborhood
    location: Asakusa, Tokyo
  - day: 2
    type: sightseeing
    description: Neighborhood tour and convenience store visit
...
<img src="/assets/2024-japan-plane.jpg" width="50%" alt="Airplane seat with flight entertainment screen showing route map from Minneapolis to Tokyo over the Pacific Ocean, with e-reader and beverage on tray table">
...
<img src="/assets/2024-tokyo-train1.jpg" width="50%" alt="Tokyo-Haneda Airport Terminal 3 train station platform with digital departure boards showing train times in Japanese, travelers with luggage, and an 'Explore Japan' banner">
...
<img src="/assets/2024-tokyo-bh-temple1.jpg" width="50%" alt="Selfie in front of a traditional Japanese temple with distinctive red and white architecture, ornate roof decorations, and visitors in traditional kimono visible in the background">

 <img src="/assets/2024-tokyo-koi.jpg" width="50%" alt="Tranquil koi pond in a Japanese temple garden with a large orange koi fish swimming, surrounded by rocks, trees, and traditional landscaping with reflections in the water">
